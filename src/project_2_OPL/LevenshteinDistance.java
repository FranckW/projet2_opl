...
public class LevenshteinDistance {
	...
	/**
	 * <p>
	 * If the threshold is not null, distance calculations will be limited to a
	 * maximum length. If the threshold is null, the unlimited version of the
	 * algorithm will be used.
	 * </p>
	 *
	 * @param threshold
	 *            If this is null then distances calculations will not be
	 *            limited. This may not be negative.
	 */
	...
	/**
	 * Find the Levenshtein distance between two CharSequences if it's less than
